...
Since the confidence interval does not include zero, we are 95% confident that the correlation between beauty score and teaching score is positive and between 0.1 and 0.3.
...
It is centered at zero since this is the assumed value under the null distribution. The p-value is going to be small.
