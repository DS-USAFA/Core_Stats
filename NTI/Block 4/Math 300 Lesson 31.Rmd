...
The purpose of hypothesis testing is to determine whether there is enough statistical evidence to support an alternative hypothesis about a population; this is evaluated but the use of a single number metric and its sampling distribution. 
