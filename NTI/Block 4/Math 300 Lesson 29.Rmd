...
**Answer:** The first variable is used as the first level of grouping. We think it is better to sort firt on gender then on decision. It makes it easier to compare male and females. 
