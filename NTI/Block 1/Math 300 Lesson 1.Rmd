...
Remember that you will be running this more like a lab than a lecture. You want to get them using `R` and answering questions. The focus will be on answering the learning checks. This will require to use our book and to use RStudio. Those should be our primary teaching tools.

+ Have a copy of the textbook open in a browser tab, the NITs in a browser tab, and the student notes Rmd open. Work through the Rmd with them using the answers in the NTI. You can go back to the book to bring clarity to specific points. 
...
* These may be installed. If so, show them how to load package using the Packages tab in RStudio. *
