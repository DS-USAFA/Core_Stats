...
**`r paste0("(LC", chap, ".", (lc <- lc + 1), ")")`** What's another way to use the "not" operator `!` to filter only the rows that are not going to Burlington, VT nor Seattle, WA in the `flights` data frame? Test this out using the code above.
